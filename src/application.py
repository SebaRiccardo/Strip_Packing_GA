...
def default_GA(number_of_rectangles, W, genes, it_rotates,seed,GENERATIONS,TOURNAMENT_SIZE):
    ...
    # Plot the info of the first individual
    plot_individual_info(best_ind,W, set_of_rectangles,RESULTS_FOLDER, it_rotates,"first_individual")
    ...
    for generation_number in range(GENERATIONS):
        ...
        print("Best of generation: %i "%(generation_number),best_of_generation)

    print("----------------------------------------")
    print("Best individual generated by the GA: ", best_ind)
    print("----------------------------------------")
    plot_stats(average_fitness, best_fitness, best_fitness_ever,"GA with rotation_"+str(it_rotates))
...
if __name__ == '__main__':
    ...
    if options["experimental"] == 1:
        ...
        plot_all_instance_solutions(statistics)
