...
def create_starting_population(population_size, max_width, rectangles, genes, fitness_fuction, it_rotates):
    return np.array([create_random_individual(genes, max_width, rectangles, fitness_fuction,it_rotates,_) for _ in range(population_size)])
